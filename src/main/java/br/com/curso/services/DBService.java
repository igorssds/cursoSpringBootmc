...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Pedido ped1 = new Pedido(null,sdf.parse("20/08/2018 10:32"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("10/06/2018 19:25"), cli1, e2);
		
		Pagamento pagto1 = new PagamentoComCartao(null,EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);
		
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/08/2018 00:00"), null);
